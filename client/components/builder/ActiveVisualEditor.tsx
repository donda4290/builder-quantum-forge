...
import { BuilderChatbotSidebar } from "./BuilderChatbotSidebar";
...
export function ActiveBuilderEditor({
  page,
  onSave,
}: ActiveBuilderEditorProps) {
        ...
        <div className="h-12 border-b bg-white dark:bg-gray-900 flex items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button
              ...
              className={
                !chatbotCollapsed ? "bg-primary/10 border-primary" : ""
              }
            >
              ...
              <span className="ml-2">
                {chatbotCollapsed ? "Show" : "Hide"} AI Assistant
              </span>
            </Button>
          </div>
        </div>
